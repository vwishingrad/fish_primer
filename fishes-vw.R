        ...
        dataset %>%
          imap(~{
            ...
            ggplot(dd) + 
              ...
              labs(title=title_map[nn],y=str_glue("Relative sequence abundance"),x="Marker")
          })
      }) 
  })
        ...
        dataset %>%
          imap(~{
            ...
            ggplot(dd) + 
              ...
              labs(title=title_map[nn],y="Number of unique taxa",x="Marker")
          })
      })
  })
...
zotu_composites$raw$species

zotu_plotz$raw$family$mock
zotu_plotz$raw$species$mock
